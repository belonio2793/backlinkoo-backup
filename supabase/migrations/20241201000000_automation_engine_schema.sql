...
-- Clean installation with table drops and recreations

-- Drop existing tables if they exist (in dependency order)
DROP VIEW IF EXISTS system_performance CASCADE;
...
DROP TABLE IF EXISTS processing_nodes CASCADE;
DROP TABLE IF EXISTS proxy_pool CASCADE;
...
CREATE INDEX idx_automation_campaigns_priority ON automation_campaigns(priority);
CREATE INDEX idx_automation_campaigns_scheduled_at ON automation_campaigns(scheduled_at);

CREATE INDEX idx_link_opportunities_campaign_id ON link_opportunities(campaign_id);
CREATE INDEX idx_link_opportunities_status ON link_opportunities(status);
CREATE INDEX idx_link_opportunities_authority ON link_opportunities(authority);
CREATE INDEX idx_link_opportunities_discovered_at ON link_opportunities(discovered_at);

CREATE INDEX idx_content_requests_campaign_id ON content_requests(campaign_id);
CREATE INDEX idx_content_requests_opportunity_id ON content_requests(opportunity_id);
...
CREATE INDEX idx_posted_links_campaign_id ON posted_links(campaign_id);
CREATE INDEX idx_posted_links_opportunity_id ON posted_links(opportunity_id);
CREATE INDEX idx_posted_links_status ON posted_links(status);
CREATE INDEX idx_posted_links_posted_at ON posted_links(posted_at);

CREATE INDEX idx_error_logs_campaign_id ON error_logs(campaign_id);
...
CREATE INDEX idx_processing_nodes_status ON processing_nodes(status);
CREATE INDEX idx_processing_nodes_region ON processing_nodes(region);

CREATE INDEX idx_campaign_metrics_timeseries_campaign_id ON campaign_metrics_timeseries(campaign_id);
CREATE INDEX idx_campaign_metrics_timeseries_timestamp ON campaign_metrics_timeseries(timestamp);
...
-- Create simplified views after tables are created
