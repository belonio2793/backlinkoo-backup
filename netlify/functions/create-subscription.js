...
const PRICING_CONFIG = {
  monthly: {
    ...
    interval: 'month',
    discount: 41,
    priceId: process.env.STRIPE_PREMIUM_PLAN_MONTHLY || process.env.STRIPE_MONTHLY_PRICE_ID || 'price_monthly_fallback',
  ...
  yearly: {
    ...
    discount: 51,
    savings: 298,
    priceId: process.env.STRIPE_PREMIUM_PLAN_ANNUAL || process.env.STRIPE_YEARLY_PRICE_ID || 'price_yearly_fallback',
