      ...
      <Card className="w-full max-w-md bg-white shadow-2xl border-0 animate-fade-in">
        ...
        <CardContent className="space-y-6">
          <div className="text-center">
            <p className="text-gray-700 mb-4" style={{ wordSpacing: 'normal', letterSpacing: 'normal' }}>
              {postTitle ? `Your blog post "${postTitle}" will be ` : "Your newly created blog post will be "}
              <span className="font-semibold text-red-600" style={{ wordSpacing: '0.25em' }}>automatically deleted</span>
              {` in ${timeRemaining} if left unclaimed.`}
            </p>
