      ...
      <Card className="w-full max-w-md bg-white shadow-2xl border-0 animate-fade-in">
        ...
        <CardContent className="space-y-6">
          <div className="text-center">
            <p className="text-gray-700 mb-4 emergency-spacing">
              {postTitle ? `Your blog post "${postTitle}"` : "Your newly created blog post"} will be{' '}
              <span className="font-semibold text-red-600">automatically deleted</span>{' '}in{' '}
              <span className="time-remaining-fix">{timeRemaining}</span>{' '}if left unclaimed.
            </p>
