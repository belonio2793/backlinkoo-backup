        ...
        <CardContent className="space-y-6">
          <div className="text-center">
            <p className="text-gray-700 mb-4">
              {postTitle ? `Your blog post "${fixTextContent(postTitle)}"` : "Your newly created blog post"} will be
              <span className="font-semibold text-red-600"> automatically deleted </span>in {processedTimeRemaining} if left unclaimed.
            </p>
