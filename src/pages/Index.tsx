        ...
        <div className="w-full space-y-32">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="bg-gradient-to-br from-green-500/5 to-primary/5 p-12 rounded-2xl order-2 lg:order-1 overflow-hidden">
              <img src="https://images.pexels.com/photos/4062185/pexels-photo-4062185.jpeg" alt="Performance Analytics" className="h-32 w-32 object-cover rounded-xl mx-auto shadow-lg" />
            </div>
