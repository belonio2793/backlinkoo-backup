                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                    <div>
                      <p className="text-green-700">
                        <span className="font-semibold">Telegraph</span> live publishing
                      </p>
                      <p className="text-green-600">
                        Real ChatGPT content generation
                      </p>
                    </div>
                    <div>
                      <p className="text-green-700">
                        <span className="font-semibold">Live</span> campaign tracking
                      </p>
                      <p className="text-green-600">
